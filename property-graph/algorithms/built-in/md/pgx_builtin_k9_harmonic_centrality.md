...
- **Javadoc:**
  - [Analyst#harmonicCentrality(PgxGraph graph)](https://docs.oracle.com/en/database/oracle/property-graph/26.2/spgjv/oracle/pgx/api/Analyst.html#harmonicCentrality_oracle_pgx_api_PgxGraph_)
  - [Analyst#harmonicCentrality(PgxGraph graph, VertexProperty<ID,​java.lang.Double> hc](https://docs.oracle.com/en/database/oracle/property-graph/26.2/spgjv/oracle/pgx/api/Analyst.html#harmonicCentrality_oracle_pgx_api_PgxGraph_oracle_pgx_api_VertexProperty_)
