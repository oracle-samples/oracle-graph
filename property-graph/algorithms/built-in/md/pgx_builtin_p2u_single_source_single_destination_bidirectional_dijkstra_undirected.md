...
- **Algorithm ID:** pgx_builtin_p2u_single_source_single_destination_bidirectional_dijkstra_undirected
...
- **Javadoc:**
  - [Analyst#shortestPathDijkstraBidirectional(PgxGraph graph, PgxVertex<ID> src, PgxVertex<ID> dst, EdgeProperty<java.lang.Double> cost, boolean ignoreEdgeDirection)](https://docs.oracle.com/en/database/oracle/property-graph/26.2/spgjv/oracle/pgx/api/Analyst.html#shortestPathDijkstraBidirectional_oracle_pgx_api_PgxGraph_oracle_pgx_api_PgxVertex_oracle_pgx_api_PgxVertex_oracle_pgx_api_EdgeProperty_boolean_)
  - [Analyst#shortestPathDijkstraBidirectional(PgxGraph graph, PgxVertex<ID> src, PgxVertex<ID> dst, EdgeProperty<java.lang.Double> cost, VertexProperty<ID,​PgxVertex<ID>> parent, VertexProperty<ID,​PgxEdge> parentEdge, boolean ignoreEdgeDirection)](https://docs.oracle.com/en/database/oracle/property-graph/26.2/spgjv/oracle/pgx/api/Analyst.html#shortestPathDijkstraBidirectional_oracle_pgx_api_PgxGraph_oracle_pgx_api_PgxVertex_oracle_pgx_api_PgxVertex_oracle_pgx_api_EdgeProperty_oracle_pgx_api_VertexProperty_oracle_pgx_api_VertexProperty_boolean_)
...
public class BidirectionalDijkstraUndirected {
  public boolean bidirectionalDijkstraUndirected(PgxGraph g, EdgeProperty<Double> weight, PgxVertex src, PgxVertex dst,
    ...
    while (!terminate && (fReachable.size() != 0) && (rReachable.size() != 0)) {
      if (fReachable.size() <= rReachable.size()) {
        ...
        rnext.getNeighbors().filter(v -> !rFinalized.get(v)).forSequential(v -> {
          PgxEdge e = v.edge();
