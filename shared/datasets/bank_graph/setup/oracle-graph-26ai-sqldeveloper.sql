...
-- At this point, load shared/datasets/bank_graph/data/BANK_ACCOUNTS.csv and shared/datasets/bank_graph/data/BANK_TRANSFERS.csv into the BANK_ACCOUNTS and BANK_TRANSFERS tables respectively.
